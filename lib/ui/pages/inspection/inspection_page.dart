...
import 'package:inspection_app/ui/pages/inspection/children/section_title.dart';
            ...
            children: [
              ...
              SectionItem(
                ...
                child: DropdownField.result(
                  ...
                  onSelect: (result) {
                    ...
                    final foundation =
                        inspection.foundation.copyWith(crack: crack);
                    ref
                        .read(inspectionProvider.notifier)
              ...
              if (inspection.foundation.concreteDeterioration.result ==
                ...
                SectionItem(
                  ...
                  child: MultiDropdownField<Direction>(
                    values:
                        inspection.foundation.concreteDeterioration.directions
                            .map((e) => SelectionItem(
                                  value: e,
                                  name: '${e.label}面',
                                ))
                ...
                child: DropdownField.result(
                  ...
                  onSelect: (result) {
                    final rust =
                        inspection.foundation.damage.copyWith(result: result);
                    final foundation =
                        inspection.foundation.copyWith(rust: rust);
                    ref
                        .read(inspectionProvider.notifier)
                        .updateFoundation(foundation);
                  },
                ...
                SectionItem(
                  ...
                  child: MultiDropdownField<Direction>(
                    ...
                    all: Direction.values
                        ...
                        .toList(),
                    onSelect: (directions) {
                      final rust = inspection.foundation.rust
                          .copyWith(directions: directions);
                      final foundation =
                          inspection.foundation.copyWith(rust: rust);
                      ref
              ...
              if (inspection.foundation.rebarExposure.result ==
                  Result.failure) ...[
                SectionItem(
                  axis: Axis.horizontal,
                  title: '　問題が確認された場所',
