...
import 'children/list_error.dart';
import 'children/list_skeleton.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ref.watch(inspectionListProvider).when(
          data: (inspections) {
          ...
          error: (error, stacktrace) {
            return ListError(
              ...
              onTapRetry: () {
                ref.read(inspectionListProvider.notifier).refresh();
              },
            );
          },
          loading: () {
            return ListSkeleton(padding: padding);
          },
        ),
      ),
    );
